 ...
 *
 * Starts a local HTTP server at port 9000 and opens a Spotify login
  ...
  return new Promise(function (resolve, reject) {
    ...
    server.get('/', function (req, res) {
      ...
      if (url.query()) {
        ...
        // the hash fragment is not part of the HTTP request, so we
        // convert it to a query string and perform a second request
        // against the server
